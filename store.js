...
(function () {
    ...
    function injectStyles() {
        ...
        s.textContent = [
            ...
            '.us-b.selector:focus,.us-b.selector.hover{border-color:#667eea;box-shadow:0 0 12px rgba(102,126,234,0.5)}',
            ...
            '.us-search input{width:100%;padding:0.7em 1em 0.7em 2.5em;border-radius:0.5em;border:2px solid rgba(255,255,255,0.1);background:rgba(255,255,255,0.04);color:#fff;font-size:0.85em;outline:none}',
